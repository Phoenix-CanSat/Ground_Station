...
bool SDInit() {
    ...
    // Data file headers.
    SDWrite("Identifier,Counter,Time,Temperature,Pressure,Latitude,Longitude,Altitude,Humidity,InternalTemperature,RSSI,GroundTemperature,GroundPressure", "data_all.csv");
